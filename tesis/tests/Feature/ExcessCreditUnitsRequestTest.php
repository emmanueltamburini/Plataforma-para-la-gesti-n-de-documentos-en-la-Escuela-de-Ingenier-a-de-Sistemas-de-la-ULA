...
class ExcessCreditUnitsRequestTest extends TestCase
{
	use RefreshDatabase;
    ...
    public function a_subjects_selection_cannot_be_empty_Excess_Credit_Units()
    {
        ...
        $response = $this->post(route('request.excess_credit_units_post',[
            'ID'   =>  $ID_crypt,
            'code' =>  $code_crypt,
        ]) ,[
            'subjects_selection' => '',
    ...
    /** @test */
    public function an_user_can_upload_subjects_selection_Excess_Credit_Units()
    {
    ...
    /** @test */
    public function an_user_can_upload_proof_notes_Excess_Credit_Units()
    {
    ...
    /** @test */
    public function an_user_can_upload_reason_letter_Excess_Credit_Units()
    {
    ...
    /** @test */
    public function a_petition_must_be_confirmed_Excess_Credit_Units()
    {
    ...
    /** @test */
    public function a_subjects_selection_must_have_a_path_Excess_Credit_Units()
    {
   ...
   //***************************Test que prueba que se guarada el path de la constancia de notas correctamente********************************
    /** @test */
    public function a_proof_notes_selection_must_have_a_path_Excess_Credit_Units()
    {
    ...
    /** @test */
    public function a_reason_letter_must_have_a_path_Excess_Credit_Units()
    {
        ...
        //*****************************Test que prueba que se guarada el path de la carta de motivo correctamente******************************
    /** @test */
    public function a_request_finished_dont_have_confirmation_code_Excess_Credit_Units()
    {
    ...
    /** @test */
    public function an_info_in_a_finished_petition_is_coherence_Excess_Credit_Units()
    {
    	//Falso de depósito de archivos
        Storage::fake(\Config::get('constants.Disco_fake'));
    ...
    /** @test */
    public function a_successful_Credit_Units_petition_send_a_successful_message()
    {
        //Falso de depósito de archivos
        Storage::fake(\Config::get('constants.Disco_fake'));
    ...
    /** @test */
    public function a_no_verified_Credit_Units_petition_send_a_danger_message()
    {
        //Falso de depósito de archivos
        Storage::fake(\Config::get('constants.Disco_fake'));
