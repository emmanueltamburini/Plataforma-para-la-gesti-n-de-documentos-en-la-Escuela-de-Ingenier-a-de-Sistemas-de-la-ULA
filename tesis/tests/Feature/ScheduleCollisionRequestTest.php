...
class ScheduleCollisionRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function a_subjects_selection_cannot_be_empty_Schedule_Collision()
    {
        ...
        $response = $this->post(route('request.schedule_collision_post',[
            'ID'   =>  $ID_crypt,
            'code' =>  $code_crypt,
        ]) ,[
            'subjects_selection' => '',
    ...
    //*****************************Test que prueba el usuario debe subir su horario actual***********************************
    /** @test */
    public function a_currently_schedule_cannot_be_empty_Schedule_Collision()
    {
        ...
        //3. Then -> Entonces se consigue un error
        $response->assertSessionHasErrors('currently_schedule');

    }

    //*****************************Test que prueba que un usuario puede subir su selección de materias al sistema********************************
    /** @test */
    public function an_user_can_upload_subjects_selection_Schedule_Collision()
    {
        ...
        $response = $this->post(route('request.schedule_collision_post',[
			...
			'currently_schedule' => UploadedFile::fake()->create('currently_schedule.pdf'),
        ]);
    ...
    /** @test */
    public function an_user_can_upload_proof_notes_Schedule_Collision()
    {
    ...
    /** @test */
    public function an_user_can_upload_reason_letter_Schedule_Collision()
    {
     ...
     /*****************************Test que prueba que un usuario puede subir su horario actual*******************************
    /** @test */
    public function an_user_can_upload_currently_schedule_Schedule_Collision()
    {
        ...
        //3. Then -> Entonces el archivo es guardado en disco correctamente
        Storage::disk(\Config::get('constants.Disco_fake'))->assertExists('currently_schedule/ID_'.$petition->id."_CI_".$petition->ID_user."_horario_actual.pdf");
    ...
    /** @test */
    public function a_petition_must_be_confirmed_Schedule_Collision()
    {
    ...
    /** @test */
    public function a_subjects_selection_must_have_a_path_Schedule_Collision()
    {
   ...
   //***************************Test que prueba que se guarada el path de la constancia de notas correctamente********************************
    /** @test */
    public function a_proof_notes_selection_must_have_a_path_Schedule_Collision()
    {
    ...
    /** @test */
    public function a_reason_letter_must_have_a_path_Schedule_Collision()
    {
        ...
        //*****************************Test que prueba que se guarada el path de la carta de motivo correctamente******************************
    /** @test */
    public function a_request_finished_dont_have_confirmation_code_Schedule_Collision()
    {
    ...
    /** @test */
    public function an_info_in_a_finished_parallel_petition_is_coherence_Schedule_Collision()
    {
    	//Falso de depósito de archivos
        Storage::fake(\Config::get('constants.Disco_fake'));
    ...
    /** @test */
    public function a_successful_Schedule_Collision_petition_send_a_successful_message()
    {
        //Falso de depósito de archivos
        Storage::fake(\Config::get('constants.Disco_fake'));
    ...
    /** @test */
    public function a_no_verified_Schedule_Collision_petition_send_a_danger_message()
    {
        //Falso de depósito de archivos
        Storage::fake(\Config::get('constants.Disco_fake'));
