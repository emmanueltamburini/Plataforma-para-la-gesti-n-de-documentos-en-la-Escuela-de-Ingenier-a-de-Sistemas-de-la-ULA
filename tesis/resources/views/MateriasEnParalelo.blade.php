    ...
    <div class="container">
        <div class="row">
            <div class="col-10 mx-auto justify-content-center">
                <h1>Formulario para solicitar materias en paralelo</h1>
                <form action="{{ route('request.parallel_post',['ID'   =>  session('ID') ,'code' =>  session('code')]) }}" method="post" class="form-group" enctype="multipart/form-data">
                    @csrf
